...
const progrmadoresEJornalista = pessoas.filter((pessoa) => {
  return (
    (pessoa.profissao === "Programador" && pessoa.idade < 29) ||
    (pessoa.profissao === "Jornalista" && pessoa.idade < 29)
  );
});

console.log(progrmadoresEJornalista);
